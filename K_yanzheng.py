...
from features import DifferentialExpression_2
...
# 文件夹base地址
basename = '/Users/jiaminsun/Downloads/paper/jiaxinpaper/codeall/DNARF/data/simulated_data/0.1-100times/rho_0.1_'
# 网络1文件名
...
for num in range(1, 2):
    ...
    G1, G2 = readdata.readdata(basename + str(num) + '/' + networkname2, basename + str(num) + '/' + networkname1)
